...
<body>
    ...
    <main class="main">
        <section class="home">
            <h1>Welcome to <span>MATCH N SET</span></h1>
            
            <button id="sign-up" class="btn" style="display:none">signup</button>
            <button id="sign-in" class="btn" style="display:none">login</button>
			<form method="post" action="">
                ...
                <div class="wc_message">
                    <h2>LOVE YOUR SPORT FIND YOUR LOVE MATCH </h2>
                ...
                <!-- Form area Sign Up -->
                    ...
                    <form action="" method="post">
                        ...
                        <center><button id="signup" class="btn-sign btn-up" name="sign_up">Signup</button></center>
                        <?php
                ...
                <div class="organize-form form-area-signin">
                    ...
                    <div class="1-part">
                        ...
                        <div class="form-field">
                            ...
                            <div class="form-field">
                                <input type="password" name="pass_word" placeholder="password" required class="form-control input-md"><br>
                            </div>
                                <a style="text-decoration:none; float:right;color:#187FAB" data-toggle="tooltip" title="forgot password" href="forgot_password.php">Forgot?</a><br><br>
